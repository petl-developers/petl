...
* Artur Poniński (`arturponinski <https://github.com/arturponinski>`_)
...
* Michał Karol (`MichalKarol <https://github.com/MichalKarol>`_)
...
* Tim Hebbeler (`timheb <https://github.com/timheb>`_)
